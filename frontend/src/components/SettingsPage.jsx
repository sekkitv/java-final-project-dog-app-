                ...
                <label style={styles.uploadBtn}>
                    ...
                    <input
                        ...
                        onChange={(e) => {
                            ...
                            if (file) setOwnerImgUrl(URL.createObjectURL(file));
                        }}
                        style={{display: 'none'}}
                    />
                </label>
        ...
        <div style={styles.sectionCard}>
            ...
            <div style={styles.photoContainer}>
                ...
                <label style={styles.uploadBtn}>
                    ...
                    <input
                        ...
                        onChange={(e) => {
                            const file = e.target.files[0];
                            if (file) setDogImgUrl(URL.createObjectURL(file));
                        }}
                        style={{display: 'none'}}
                    />
                </label>
            ...
            <div style={styles.sliderContainer}>
                <div style={styles.sliderHeader}>
                    ...
                    <span style={styles.sliderValue}>{dogAge} {dogAge === '1' ? 'year' : 'years'} old</span>
                </div>
                <input
                    type="range"
                    min="0"
