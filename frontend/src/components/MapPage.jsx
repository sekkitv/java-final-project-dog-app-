...
export default function MapPage() {
  ...
  const handleSaveEvent = async (e) => {
    ...
    try {
      ...
      const response = await api.createHangout(newEvent);
      setHangouts((prev) => [...prev, response]);
      setMyHangouts((prev) => [...prev, response]);
    ...
    <div style={styles.mainPageWrapper}>
      <div style={styles.leftMainColumn}>
        <div style={styles.container}>
              ...
              <div style={styles.headerRow}>
                <div style={styles.titleGroup}>
                  ...
                  <span style={styles.subtitle}>
                    click the map to plan a new hangout
                  </span>
                </div>

                <div style={styles.headerButtons}>
                  <button
                    style={styles.myAreaBtn}
                    title="My area"
                    onClick={myAreaClicked}
                  >
                    📍 My area
                  </button>
                  <button
              ...
              <div style={styles.mapWrapper}>
                ...
                >
                  ...
                  <Marker
                    ...
                    icon={MAP_ICONS.USER_LOCATION || MAP_ICONS.DEFAULT}
                  >
                    <Popup>
                    ...
                    .map((item) => {
                      ...
                      return (
                        <Marker
                          ...
                          icon={
                            getHangoutIcon
                              ? getHangoutIcon(hangoutType)
                              : MAP_ICONS[hangoutType] || MAP_ICONS.DEFAULT
                          }
                        >
                          <Popup>
          ...
          <UserEvents myHangouts={myHangouts} setMyHangouts={setMyHangouts} />
          {/* Add Event Modal */}
          {isCreateModalOpen && (
              ...
              <div style={styles.createModalCard}>
                ...
                <div style={styles.locationBannerRow}>
                  <div style={styles.locationText}>
                    📍 Location: {Number(formData.latitude).toFixed(4)},{" "}
                    ...
                    {EVENT_TYPES.map((typeObj) => {
                      ...
                      return (
                        <button
                          ...
                          type="button"
                          onClick={() =>
                            handleInputChange("activityType", typeObj.id)
                          }
                          style={{
                            ...styles.typeBtn,
            ...
            <div style={styles.modalOverlay}>
              <div style={styles.modalCard}>
                ...
                <p style={styles.modalText}>
                  <b>Organizer:</b> {selectedHangout.organizerName}
                </p>
                <p style={styles.modalText}>
                  <b>When:</b> {formatEventTime(selectedHangout.eventTime)}
                </p>
                <p style={styles.modalText}>
                  <b>Participantcs:</b> {selectedHangout.participantCount}
                </p>
